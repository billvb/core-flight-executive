/*
** $Id: cfe_time_tone.c 1.7 2010/10/04 17:04:52EDT jmdagost Exp  $
**
**
**
...
#endif /* end of #ifdef CFE_TIME_CFG_SRC_TIME */
        ...
        */
        ...
        if (Result == CFE_SUCCESS)
        {
            ...
            */
            ...
            /*
            ** Send 1Hz timing packet (some day the scheduler will do this)...
            */
